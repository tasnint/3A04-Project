...
\begin{enumerate}[{UH-EOU}1. ]
    \item The application shall have an intuitive user interface  (UI) such that a user will grasp how to use the application almost instantly by providing a tutorial at initial startup.
...
\begin{enumerate}[{UH-PI}1. ]
    ...
    \item Users data shall be stored and only linked to the user's account so that users can get personalized food recommendations based on their activity history.
    \item The system shall adapt to each user's dietary restirictions, allergies and food personalization, ensuring that food returns comply with the user's specified preferences. \\
    \textbf{Rationale:} Each user has different food and ingredient restrictions and preferences and the system needs to adapt to these user personalization for user adaptability.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{UH-L}1. ]
	\item The system shall continuously learn and understand the custom recipes that are added by users so that it can suggest these new recipes to other users with similar queries. \\
	\textbf{Rationale:} To enhance user engagement and foster community interaction within the application, the system needs to learn and know the receipes that are being added to its database so that it can share these recipes with the most relevant users based on their preferences and activity.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-SL}1. ]
	\item The latency between sending a request for classification and getting the response, assuming a stable internet connection shall be no greater than ten (10) seconds.
    \item The application's loading time shall not exceed twenty (20) seconds.
    \item The latency between changing pages within an application shall be negligible, assuming a stable internet connection.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-SC}1. ]
	\item The system shall not treat non-food items as food, which may lead a naive user to consume the non-food item and suffer adverse affects
	\item The system shall include allergen information, or warn users to ensure they are not allergic or intolerant to a food before trying it.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-C}1. ]
	...
	\item The system shall accept at most 1 picture at a time. \\
	\textbf{Rationale:} The application is a light system and needs to be able to process data at high speeds.
	\item The system shall accept no more than 50 ingredients at a time. \\
	\textbf{Rationale:} The application is a light system and needs to be able to process data at high speeds.
	\item The system shall accept no more than 500 character of textual input at a time. \\
	\textbf{Rationale:} The application is a light system and needs to be able to process data at high speeds.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{OE-IA}1. ]
	...
	\item The appication shall be able to be deployed on IOS in the future to expand the audience.
	\item The application shall conform to the terms of service of the Apple Application store.
