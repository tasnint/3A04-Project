...
\begin{enumerate}[{LR-STD}1. ]
    \item \textit{The app should not use notifications for promotional/advertisement purposes.}
    ...
    \item \textit{The app’s internal storage should be used to store any sensitive data.}
...
\begin{itemize}
	...
	\item Inputting textual data about the dish, possibly including an ingredients list or even a recipe. This may
	compliment or subsitute photo input.
