...
\begin{enumerate}[{LF-S}1. ]
    \item \textit{The application shall use sans-serif for all its text.} \\ \textbf{Rationale:} Studies indicate it is more readable than serif counterparts \footnote{\href{https://www.adobe.com/creativecloud/design/discover/serif-vs-sans-serif.html?msockid=01fdfd2fd30062062dabe84fd2aa630e}{Adobe: Serif vs. sans serif}}
...
\begin{enumerate}[{UH-PI}1. ]
    \item The application shall be available both in light mode and dark mode. \\ \textbf{Rationale:} Some end users prefer light mode and some prefer dark mode, and having both modes will capture the full gamut. \footnote{\href{https://www.nngroup.com/articles/dark-mode/}{NN Group: Dark Mode}}. 
...
\begin{enumerate}[{UH-UP}1. ]
	\item \textit{Responses shall be easily understood by the end user, including users with an advanced but not fluent understanding of English.} \\ \textbf{Rationale:} This application will be initially available only in English. Many people have an advanced but not fluent understanding of English \footnote{\href{https://www.census.gov/library/visualizations/interactive/people-that-speak-english-less-than-very-well.html}{US Census Bureau - People that Speak English Less than Very Well}} and simplifying the language will accommodate them without reducing the application's quality.
        \item \textit{Prompts should use polite phrases such as "please" when requesting and "thank you" after a user fulfills a request.} \\ \textbf{Rationale:} People appreciate polite language.\footnote{\href{https://www.gsb.stanford.edu/insights/magic-words-change-what-you-say-inspire-influence-others}{Stanford Graduate School of Business}}
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR-SL}1. ]
	\item The latency between sending a request for classification and getting the response, assuming a stable internet connection shall be no greater than three (3) seconds. \\ \textbf{Rationale:} Image processing standards demand a response within three (3) seconds. \footnote{\href{https://eumentis.com/blog/evaluating-the-performance-of-an-image-classification-model}{Eumentis: Evaluating the performance of an image classification model}}
    \item \textit{The application's loading time shall not exceed two (2) seconds}. \\ \textbf{Rationale:} Roughly half of users will abandon an application that takes three (3) or more seconds.\footnote{\href{https://www.storyly.io/glossary/app-loading}{Storyly - App Loading}}
...
\begin{enumerate}[{PR-RA}1. ]
	\item \textit{The application shall be available 99\% of the time.} \\ \textbf{Rationale:} This is a standard for a non-critical application, like this one. \footnote{\href{https://www.concretecms.com/about/blog/digital-business/uptime}{Concrete CMS - Uptime}}
...
\begin{enumerate}[{OE-IA}1. ]
	\item \textit{This application shall be compatible with mobile devices running the Android platform.} \\ \textbf{Rationale:} This is part of the specification.
        \item \textit{This application shall conform to the terms of service of the Android Application store.} \\ \textbf{Rationale:} Sideloading may be dangerous \footnote{\href{https://www.trio.so/blog/app-sideloading/}{Trio - App Sideloading}} and will discourage users from downloading the application. The only way for Android users to download it without sideloading is to be approved by the Android Application Store.
        \item \textit{If a parallel iOS mobile application is developed, it shall conform to the terms of service of the Apple Application store.} \textbf{Rationale:} Sideloading may be dangerous \footnote{\href{https://www.trio.so/blog/app-sideloading/}{Trio - App Sideloading}} and will discourage users from downloading the application. The only way for Apple users to download it without sideloading is to be approved by the Apple Application Store.
