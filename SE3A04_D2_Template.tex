...
\\
\\
Dish Determination is characterized by complex decision-making based on 3 expert modules acting as independent and swappable knowledge sources, making Blackboard the ideal architecture style for this subsystem. 
The Dish Determination system actively evaluates and combines inputs from three modules, Image Recognition, Text Description, and Ingredient-Based Experts. 
An internal controller embedded within this subsystem is responsible for aggregating inputs and managing confidence levels to determine the most accurate dish identification. 
